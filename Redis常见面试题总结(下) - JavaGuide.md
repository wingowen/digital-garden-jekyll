...
[![](https://javaguide.cn/database/redis/redis-questions-02.html/logo.png)JavaGuide](/)
...
[Guide](https://javaguide.cn/article/)数据库Redis约 10987 字大约 37 分钟
...
[![JavaGuide官方知识星球](https://oss.javaguide.cn/xingqiu/xingqiu.png)](/about-the-author/zhishixingqiu-two-years.html)
...
#### [bigkey 是怎么产生的？有什么危害？](#bigkey-是怎么产生的-有什么危害)
...
在 [Redis 常见阻塞原因总结](/database/redis/redis-common-blocking-problems-summary.html) 这篇文章中我们提到：大 key 还会造成阻塞问题。具体来说，主要体现在下面三个方面：
...
[编辑此页](https://github.com/Snailclimb/JavaGuide/edit/main/docs/database/redis/redis-questions-02.md)

上次编辑于: 2025/3/11 16:33:12

贡献者: guide,Guide,Mr.Hope,复制粘贴委员会首席技术专家, 加里敦大学著名bug架构师,wunameya,26684,XiangdongHe,xuqi,595lzj
...
](/database/redis/redis-questions-01.html)[
